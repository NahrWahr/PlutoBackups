...
# ╔═╡ caa58a90-161f-11ed-3b96-df4a0ed5efa0
begin
	using Symbolics
	using Latexify
	using Unitful
...
# ╔═╡ 4db932bc-b559-4d65-a880-c6a49f40d1b8
global G = 6.6743e-11u"m^3/(kg*s^2)"

# ╔═╡ 24e65d13-3157-4c62-9818-54d02c15b61d
begin
	m1 = 32*10e6u"kg"
	m2 = 5*10e15u"kg"
	μ = m1/m2
...
# ╔═╡ c64b2ea3-04b2-474c-a9c1-0fdbf0f57bd3
G*m1

# ╔═╡ 723bf851-3d84-4fd2-a2d4-280991bc3899
u = μ*(-1+x+μ)/(y^2+z^2+(-1+x+μ)^2)^(3/2)
