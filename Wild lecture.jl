...
begin
	...
	EM=permutedims(hcat(EM...))
	Image = load("/home/rnarwar/Pixxel/project/testdata/FabricatedDataCube/FlatImage.jld2", "madeupimage")
end
  ╠═╡ =#

# ╔═╡ 83f7f187-70b5-400a-815b-4fda4b1ab6c1
function loss(x,y)
	Flux.Losses.mse(predict(x),y)
end

# ╔═╡ a2ea5d81-4437-4fdd-8fde-0b82fb339c73
begin
	W = rand(200,5)
	b = rand(200)
	predict(x) = W*x .+ b
	...
	x,y = rand(5), rand(200)
	gs = Flux.gradient(() -> loss(x,y), Flux.params(W))
	W = W - gs[W]
end

# ╔═╡ 7a49a196-1978-4f52-8038-961f9e7670f4
loss(x,y)
