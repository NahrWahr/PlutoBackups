...
# ╔═╡ ccd392e8-ea1b-492f-9dc3-db2d528ba208
using Symbolics, Latexify

# ╔═╡ 1ab51686-39b1-411a-bbe7-a35521c0e2fb
using Plots, PlutoUI

# ╔═╡ e8dd78cf-b7be-4acf-81d8-87eafcfdbec1
using StaticArrays

# ╔═╡ a55b925e-0286-11ed-3b22-b77fa1c2275b
#using Statistics, LinearAlgebra

# ╔═╡ 8b58c62a-3d06-442a-bbeb-3a06d0867637
function ding(N::Int64)
	a = Vector{Float32}(undef, N)

	a[begin]=1
	for i=2:N
		a[i] = (a[i-1] + randn())/a[i-1]
	end
	return a
end

# ╔═╡ 6c4aa392-287f-4979-bde0-4fc6aaa80bb4
function dong(N::Int64)
	a = Vector{Float32}(undef, N)

	a[begin]=1
	for i=2:N
		@inbounds a[i] = (a[i-1] + randn())/a[i-1]
	end
	return a
end

# ╔═╡ 5b7e1627-8d6a-4883-8a90-fbcffd8ef1cd
e = 22

# ╔═╡ bf2a9830-0649-4a78-bfb6-f0831f32af0b
maximum(dong(2^e))

# ╔═╡ 9edeefc9-8d80-47ec-b2a1-13dbaa281b76
@time ding(2^e)

# ╔═╡ b441cebe-088e-4883-a6f2-ffc9bacca61e
@time dong(2^e)
