...
function Flat(Data::Array{UInt8})::Array{UInt8}
	a,b,c =size(Data)
	Out = reshape(Data, a*b, c)
	return Out
end

# ╔═╡ 7615661f-20db-4de6-9f47-61f09bb5b366
begin
	X = get(load("/home/rnarwar/Pixxel/project/testdata/raw.jld2"), "Data",1);
	X = Flat(X)
end

# ╔═╡ e5dd866f-ab0d-41ce-81b0-7c2c2acb8016
function Discard0(Data::Matrix{UInt8})
	Out = []
	for i in 1:size(X,1)
		if sum(X[i,:]) != 0
			push!(Out, X[i,:])
...
# ╔═╡ 227d4a12-86c0-4f71-9c14-6e2ee8352151
begin
	Y = Discard0(X)
	Y = permutedims(hcat(Y...))
end

# ╔═╡ 734af5f0-8ea2-4cb1-be88-fc1099af08cd
#npzwrite("/home/rnarwar/Pixxel/project/testdata/FlatARD.npz", Y)
...
# ╔═╡ Cell order:
# ╠═d0cf6447-2471-48ec-90b2-c4a110224330
# ╠═6288e319-60ce-4ade-847a-a3a8282e0cda
# ╠═fedf0086-2271-42c9-80df-de34fe441b75
# ╟─7a54656e-2926-46e6-8f29-c73015b3a78b
# ╠═66411c4c-551c-4686-82ff-2b7bfd9063e4
# ╠═7615661f-20db-4de6-9f47-61f09bb5b366
